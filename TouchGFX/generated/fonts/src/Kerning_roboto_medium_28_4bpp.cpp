...
KEEP extern const touchgfx::KerningNode kerning_roboto_medium_28_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    { 0x0054, -1 },  // (First char = [0x0054, T], Second char = [0x0020,  ], Kerning dist = -1)
    { 0x002E, -4 },  // (First char = [0x002E, .], Second char = [0x0022, "], Kerning dist = -4)
    { 0x0041, -2 },  // (First char = [0x0041, A], Second char = [0x0022, "], Kerning dist = -2)
    { 0x004C, -4 },  // (First char = [0x004C, L], Second char = [0x0022, "], Kerning dist = -4)
    { 0x0068, -1 },  // (First char = [0x0068, h], Second char = [0x0022, "], Kerning dist = -1)
    { 0x006D, -1 },  // (First char = [0x006D, m], Second char = [0x0022, "], Kerning dist = -1)
    ...
    { 0x0022, -1 },  // (First char = [0x0022, "], Second char = [0x006F, o], Kerning dist = -1)
