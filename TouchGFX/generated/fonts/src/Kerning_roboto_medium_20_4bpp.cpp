...
KEEP extern const touchgfx::KerningNode kerning_roboto_medium_20_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x002E, -3 },  // (First char = [0x002E, .], Second char = [0x0022, "], Kerning dist = -3)
    { 0x0041, -1 },  // (First char = [0x0041, A], Second char = [0x0022, "], Kerning dist = -1)
    { 0x004C, -3 },  // (First char = [0x004C, L], Second char = [0x0022, "], Kerning dist = -3)
