...
KEEP extern const touchgfx::KerningNode kerning_roboto_medium_12_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    { 0x002E, -2 },  // (First char = [0x002E, .], Second char = [0x0022, "], Kerning dist = -2)
    ...
    { 0x002E, -2 },  // (First char = [0x002E, .], Second char = [0x0027, '], Kerning dist = -2)
    { 0x0041, -1 },  // (First char = [0x0041, A], Second char = [0x0027, '], Kerning dist = -1)
    ...
    { 0x0027, -1 },  // (First char = [0x0027, '], Second char = [0x006F, o], Kerning dist = -1)
